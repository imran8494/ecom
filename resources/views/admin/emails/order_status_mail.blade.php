...
<body>
    ...
    @if (($details['order_dtls']->courier_name != null) && ($details['order_dtls']->tracking_number != null))
        <tr>
            <td>Courier Name is {{ $details['order_dtls']->courier_name }} and tracking number is {{ $details['order_dtls']->tracking_number }}.</td>
        </tr> <br>
    @endif
    <tr>
        <td>Thank you for shopping with us. Your order no #{{ $details['order_id'] }} status has been updated to {{ $details['order_status'] }}. Your order details are as below:-</td>
    </tr> <br>
