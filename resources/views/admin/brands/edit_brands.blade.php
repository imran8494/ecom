                    ...
                    <div class="card">
                        <div class="">
                            <div class="card-header">
                                <h3 class="card-title" id="heading">Edit Brand </h3>
                            </div>
                            <div id="success_message" class="btn-success"></div>
                            <form id="form_data" action="{{ route('submit_edit_brand',$data->id) }}" method="post">
                                @csrf
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="brand_name"
                                                        id="brand_name" value="{{ $data->brand_name }}">
                                                    @error('brand_name')<span
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {!! form_dropdown('status', status(), $data->status, 'id="status" class="form-control select2" required')  !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="float-right">
                                            <button id="send_form" type="submit" class="btn btn-primary configreset">Save</button>
                                        </div>
                                    </div>
