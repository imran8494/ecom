  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        @endif
        <!-- form start -->
        <form role="form" action="{{ route('admins_update_password') }}" name="updatePasswordForm" id="updatePasswordForm" method="post">
            @csrf
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" route="{{'admin_update_password'}}" name="current_password" id="current_password" placeholder="Current Password">
